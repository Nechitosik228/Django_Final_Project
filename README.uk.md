...
2. **Отримання ключа:**
    ...
    Перейдіть до вашої [панелі управління](https://mailboxlayer.com/dashboard), і там ви знайдете ключ доступу. Скопіюйте його, а потім переходьте до [Інсталяції](#installation)
